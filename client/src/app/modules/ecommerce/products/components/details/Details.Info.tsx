...
export const DetailsTable: React.FC<{
  ...
  return (
    <>
      <div className="xl:col-span-1 p-2 border-l">
...
const DetailsInfo: React.FC<DetailsInfoProps> = ({
  ...
  return (
    <Card className="bg-card border-b border-t rounded-none text-card-foreground flex flex-col gap-6">
                ...
                <CollapsibleContent className="flex flex-col gap-2">
                  {returnPolicy && (
                    <div className="rounded-md border px-4 py-2 text-sm">
                      <strong>Politica de Devolución:</strong> {returnPolicy}
                    </div>
                  )}
                  {shippingInformation && (
                    <div className="rounded-md border px-4 py-2 text-sm">
